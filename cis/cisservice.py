...
class CISService(unittest.TestCase):
    def __init__(self, testName, *args):
        ...
        self.endpoint = configs.config.Hover
    ...
    def testValidTN_SingleCustomerCSG_Success1(self):
        ...
        self.testId = "cis_test_006_Success1"
        response = requests.get(self.endpoint)
        output = response.json()
        cisService = CISService("testValidTN_SingleCustomerCSG_Success1")
        cisService.writeResponseToFile(output)
        cisService.printOutput(self.testId, output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testValidTN_CIS_Timeout_Failure")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testValidTN_CIS_Exception_Success")
#         cisService.writeResponseToFile(output)
#         cisService.printOutput("cis_test_014_Success", "testValidTN_CIS_Exception_Success", output)
#         self.assertEqual(output[1]['tnType'], 'UNKNOWN')
#         self.assertEqual((len(output[0])), 2)
#         self.assertEqual((len(output)), 6)
#  
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testValidTN_CIS_Exception_Failure")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInvalidTN_Length_Success")
#         cisService.writeResponseToFile(output)
#         cisService.printOutput("cis_test_017_Success", "testInvalidTN_Length_Success", output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInvalidTN_Length_Failure")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInValidTN_AlphaNumeric_Success")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInValidTN_AlphaNumeric_Failure")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInvalidTN_NPA_Success")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInvalidTN_NPA_Failure")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInvalidTN_NXX_Success")
#         cisService.writeResponseToFile(output)
#         cisService.printOutput("cis_test_020_Success", "testInvalidTN_NXX_Success", output)
#         print response.status_code
#         self.assertEqual(response.status_code, 500)
#         # self.assertEqual(len(output[0][0]), 16)
#  
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInvalidTN_NXX_Failure")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInvalidTN_NXX_N11_Success")
#         cisService.writeResponseToFile(output)
#         cisService.printOutput("cis_test_021_Success", "testInvalidTN_NXX_N11_Success", output)
#         print response.status_code
#         self.assertEqual(response.status_code, 500)
#         # self.assertEqual(len(output[0][0]), 16)
#  
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInvalidTN_NXX_N11_Failure")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInvalidTN_NXX_555_Success")
#         cisService.writeResponseToFile(output)
#         cisService.printOutput("cis_test_022_Success", "testInvalidTN_NXX_555_Success", output)
#         print response.status_code
#         self.assertEqual(response.status_code, 500)
#         # self.assertEqual(len(output[0][0]), 16)
#  
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInvalidTN_NXX_555_Failure")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInValidTN_Identical_Success")
#         cisService.writeResponseToFile(output)
#         cisService.printOutput("cis_test_023_Success", "testInValidTN_Identical_Success", output)
#         print response.status_code
#         self.assertEqual(response.status_code, 500)
#         # self.assertEqual(len(output[0][0]), 16)
#  
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testInValidTN_Identical_Failure")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testValidTN_Attroute_Timeout_Success")
#         cisService.writeResponseToFile(output)
#         cisService.printOutput("cis_test_006_Success", "testValidTN_Attroute_Timeout_Success", output)
#         self.assertEqual(output[1]['tnType'], 'ALTERNATE')
#         self.assertEqual((len(output[0]['account'])), 13)
#         self.assertEqual((len(output)), 6)
#           
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testValidTN_Attroute_Timeout_Failure")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testValidTN_Attroute_Exception_Success")
#         cisService.writeResponseToFile(output)
#         cisService.printOutput("cis_test_050_Success", "testValidTN_Attroute_Exception_Success", output)
#         self.assertEqual(output[1]['tnType'], 'ALTERNATE')
#         self.assertEqual((len(output[0]['account'])), 13)
#         self.assertEqual((len(output)), 6)
#           
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testValidTN_Attroute_Exception_Failure")
#         cisService.writeResponseToFile(output)
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testValidTN_Attroute_NotAvailable_Success")
#         cisService.writeResponseToFile(output)
#         cisService.printOutput("cis_test_051_Success", "testValidTN_Attroute_NotAvailable_Success", output)
#         self.assertEqual(output[1]['tnType'], 'ALTERNATE')
#         self.assertEqual((len(output[0]['account'])), 13)
#         self.assertEqual((len(output)), 6)
#           
...
#         response = requests.get(uri)
#         output = response.json()
#         cisService = CISService("testValidTN_Attroute_NotAvailable_Failure")
#         cisService.writeResponseToFile(output)
